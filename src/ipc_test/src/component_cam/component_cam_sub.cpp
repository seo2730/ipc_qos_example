#include "component_cam/component_cam_sub.hpp"

namespace component_cam
{

WebcamSubscriber::WebcamSubscriber(const rclcpp::NodeOptions &options) : Node("component_cam_sub", rclcpp::NodeOptions().use_intra_process_comms(true))
{
  // Create a subscription on the input topic which prints on receipt of new messages
  this->subscriber_ = this->create_subscription<sensor_msgs::msg::Image>("image", 10, 
...
RCLCPP_COMPONENTS_REGISTER_NODE(component_cam::WebcamSubscriber)
